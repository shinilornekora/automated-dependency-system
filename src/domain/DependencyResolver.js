...
function main() {
  ...
  console.log('Final Resolutions:', resolutions);

  // Optional: Write resolutions to a file or update package.json/yarn.lock if desired.
  // For example, you could write a "resolutions" field (supported by Yarn):
  // resolver.packageJson.resolutions = resolutions;
  // fs.writeFileSync('package.json', JSON.stringify(resolver.packageJson, null, 2));
}
